module Pod
  class Builder
    def initialize(source_dir, static_sandbox_root, dynamic_sandbox_root, public_headers_root, spec, embedded, mangle, ignore_mangle_pods, ignore_mangle_syms, dynamic)
      ...
      @embedded = embedded
      @mangle = mangle
      @ignore_mangle_pods = ignore_mangle_pods
    ...
    def build_with_mangling(platform, options)
      ...
      defines = Symbols.mangle_for_pod_dependencies(@spec.name, @ignore_mangle_pods, @ignore_mangle_syms, @static_sandbox_root)
